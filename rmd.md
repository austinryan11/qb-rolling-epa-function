...
The following assumes you have some familiarity with nflfastR. If you don't but are interested in learning more I recommend starting with Ben Baldwin's nflfastR begginer's guide or Lee Sharpe's R and RStudio Intro.
...
```
While we are here let's look at some quarterback's!
